                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <label for="group-name" class="form-label">${await translate("chat.group_name")} :</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="create-group-btn" type="button" class="btn btn-primary" data-bs-dismiss="modal">${ await translate("create") }</button>
                        </div>
                    </div>
                </div>
            </div>`
